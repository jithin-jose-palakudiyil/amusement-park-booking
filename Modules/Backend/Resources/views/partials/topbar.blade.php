<!-- Main navbar -->
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-header">
			<a class="navbar-brand" href="{{URL(admin_prefix)}}"><img src="{{asset('public/global_assets/images/logo_light.png')}}" alt=""></a>
...
<!--				<li class="dropdown language-switch">
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						...
						<span>{{Auth::guard(admin_guard)->user()->name}}</span>
						<i class="caret"></i>
					</a>
...
<!--						<li><a href="#"><i class="icon-user-plus"></i> My profile</a></li>
						...
						<li><a href="{{url(admin_prefix.'/logout')}}"><i class="icon-switch2"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
